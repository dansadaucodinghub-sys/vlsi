# Combinational Circuits Using Gate-Level Modeling

This folder contains common combinational blocks built from Verilog primitive gates (`and`, `or`, `not`, `xor`, `xnor`, and so on) wired together. None of the designs use `assign` statements.
...
| 1-bit Comparator | `comparator1bit` | `comparators/comparator1bit` |
| 2-bit Comparator | `comparator2bit` | `comparators/comparator2bit` |
| 2x4 Decoder | `decoder2x4` | `decoders` |
...
| 4x1 Multiplexer | `mux4x1` | `mux/mux_4x1` |
