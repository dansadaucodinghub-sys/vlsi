# 1x4 Demultiplexer Using 1x2 Demultiplexers - Structural Modeling

This directory contains a hierarchical RTL implementation of **1x4 Demultiplexer Using 1x2 Demultiplexers**.
...
| File | Description |
|---|---|
| `demux1x4_structural.v` | Structural RTL design |
| `demux1x4_structural_tb.v` | Testbench with `$monitor` and FSDB dump |
