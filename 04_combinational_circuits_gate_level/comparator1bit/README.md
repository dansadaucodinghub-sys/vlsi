...
This directory contains a synthesizable Verilog implementation of a **1-bit Comparator** using dataflow modeling.

## Files

| File | Description |
|---|---|
| `comparator1bit.v` | RTL design |
| `comparator1bit_tb.v` | Testbench with `$monitor` and FSDB dump |
